...
<script type="text/javascript">
	...
	function doExport(){
		//导出文件;
		window.location.href="${pageContext.request.contextPath}/subareaAction_exportXlsFile.action";
	}
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/subareaAction_findSubarea.action",
			idField : 'id',
			columns : columns,
		...
		$("#save").click(function() {
			//点击保存添加或修改subrea
			var isValid = $('#editSubreaForm').form('validate');
			if (isValid){
				$('#editSubreaForm').submit();		
			}	
		});
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="editSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id = "editSubreaForm" method="post" action="${pageContext.request.contextPath }/subareaAction_editSubarea.action">
