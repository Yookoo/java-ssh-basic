...
<script type="text/javascript">
	...
	function doAssociations(){
		...
		if(rows.length == 1){
			...
			var url1="${pageContext.request.contextPath }/decidedzoneAction_findnoassociationCustomer.action";
			...
			var url2="${pageContext.request.contextPath }/decidedzoneAction_findhasassociationCustomer.action";
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/decidedzoneAction_findDecidedzoneByPage.action",
			idField : 'id',
			columns : columns,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="定区添加修改" id="editDecidedzoneWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id = "editDecidedzoneForm" action="${pageContext.request.contextPath }/decidedzoneAction_editDecidedzone.action" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr height="300">
						...
						<td>
							...
							data-options="url:'${pageContext.request.contextPath }/subareaAction_findSubareaNotAssociation.action',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
